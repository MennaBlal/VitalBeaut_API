...
namespace EcommercePro.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        {
            List<Product> products = _productRepository.GetProductByName(name);
            List<ProductData> productData = products.Select(p => new ProductData
            {
                Id = p.Id,
                Name = p.Name,
                ...
                image = p.ImagePath,
                BrandId = p.BrandId ?? 0 // Use 0 as the default value if BrandId is null
            }).ToList();
            return productData;
        }
        ...
        {
            List<Product> products = _productRepository.GetProductByPriceRange(minPrice, maxPrice);
            List<ProductData> productData = products.Select(p => new ProductData
            {
                Id = p.Id,
                Name = p.Name,
        ...
        {
            List<Product> products = _productRepository.GetProductByCategory(categoryId);
            List<ProductData> productData = products.Select(p => new ProductData
            {
                Id = p.Id,
                Name = p.Name,
        ...
        {
            List<Product> products = _productRepository.GetProductByBrand(brandId);
            List<ProductData> productData = products.Select(p => new ProductData
            {
                Id = p.Id,
                Name = p.Name,
